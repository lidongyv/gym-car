# -*- coding: utf-8 -*-
# @Author: yulidong
# @Date:   2019-07-26 16:36:10
# @Last Modified by:   yulidong
# @Last Modified time: 2019-07-27 04:41:52
...
class conv2DBatchNormRelu(nn.Module):
    def __init__(self, in_channels, n_filters, k_size=3,  stride=1, padding=0, bias=True, dilation=1):
...
class conv2D(nn.Module):
    def __init__(self, in_channels, n_filters, k_size=3,  stride=1, padding=0, bias=True, dilation=1,group_dim=group_dim):
...
class deconv2DBatchNormRelu(nn.Module):
    def __init__(self, in_channels, n_filters, k_size=3, stride=1,output_padding=0, padding=0, bias=True):
...
class Linear(nn.Module):
    def __init__(self,in_feature,out_feature,bias=True):
        ...
        linear = nn.Linear(in_feature,out_feature,bias)
        self.cbr_unit = nn.Sequential(linear)
