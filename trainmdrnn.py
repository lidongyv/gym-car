...
mdrnn=torch.nn.DataParallel(mdrnn,device_ids=[1,2,3,4,5,6,7,0])
mdrnn.cuda(1)
#mdrnn.to(device)
...
train_loader = DataLoader(
    _RolloutDataset('datasets/carracing_rnn',train=True),
    batch_size=BSIZE, num_workers=8, shuffle=True)
test_loader = DataLoader(
    _RolloutDataset('datasets/carracing_rnn',train=False),
